...
```php
    ->add(FormComponent::switch('enabled', $this->enabled)->label(__('Your label'))->info(__('info popup explanation')))
    ->add(FormComponent::checkbox('active', $this->enabled)->label(__('Your label'))->info(__('info popup explanation')))
    ->add(FormComponent::checkbox('active', $this->enabled)->label(__('Your label'))->info(__('info popup explanation')))
```
